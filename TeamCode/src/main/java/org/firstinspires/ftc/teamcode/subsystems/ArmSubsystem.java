...
public class ArmSubsystem extends SubsystemBase {
    ...
    public static final int WRIST_OUT_MAX_SLIDE_POSITION = 1971;

    public static final int ELBOW_MAX_POSITION = 714;
    public static final int SLIDE_MIN_POSITION = 0;
    public static final int ELBOW_MIN_POSITION = 0;
    public static final int TICKS_PER_ELBOW_ROTATION = 2856;
